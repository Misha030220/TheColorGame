...
function setup() {
  ...
  // Die Ballgeschwindigkeit wird basierend auf der Höhe des Geräts skaliert
  ballSpeed = baseSpeed * (deviceHeight / referenceHeight);
...
function resetGame() {
  ...
  // Ballgeschwindigkeit erneut setzen
  ballSpeed = baseSpeed * (deviceHeight / referenceHeight);
